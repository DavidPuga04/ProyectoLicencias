...
class AfluenciaHistorica(models.Model):
    sucursal = models.ForeignKey(Sucursal, on_delete=models.CASCADE, related_name='historicos')
...
class TramiteLicencia(models.Model):
    ...
    # Paso 2
    archivo_sangre = models.FileField(upload_to='sangre/', null=True, blank=True)
    # Paso 3
    archivo_psico = models.FileField(upload_to='psicosensometrico/', null=True, blank=True)
    # Paso 4
